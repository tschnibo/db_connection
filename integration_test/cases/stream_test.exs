defmodule StreamTest do
  ...
  test "stream returns result" do
    ...
    assert P.transaction(pool, fn(conn) ->
      ...
      assert %DBConnLegacy.Stream{} = stream
  ...
  test "stream logs result" do
    ...
    assert_received %DBConnLegacy.LogEntry{call: :declare} = entry
  ...
  test "stream logs first disconnects" do
    ...
    assert_received %DBConnLegacy.LogEntry{call: :declare}
    ...
    refute_received %DBConnLegacy.LogEntry{call: :deallocate}
  ...
  test "stream logs deallocate disconnect" do
    ...
    assert_received %DBConnLegacy.LogEntry{call: :declare}
    assert_received %DBConnLegacy.LogEntry{call: :first}
